...
if __name__ == '__main__':
    data_path = './dataset/'
    model_name = 'HGNR_social_group4'
    config = {
    'gpu_num': '0',
    'batch_size' : [1024],
    'data_path' : [data_path+'epinion91', data_path+'epinion82'],
    'neg_item' : 1,
    'n_embedding' : 64,
    'topk' : 10,
    ...
    config['hgnr'] = True if model_name == 'HGNR_social_group4' else False
    os.environ["CUDA_VISIBLE_DEVICES"] = "1" if model_name == 'HGNR_social_group4' else "0"
        
    for i, path in enumerate(config['data_path'][0:]):
        config['save_model'] = './HGNR/save_model/' + "{}_{}_".format(
                    'HGNR_social_group4' if model_name == 'HGNR_social_group4' else 'NGCF',
                    path[len(data_path):],
                    )
            ...
            for batch_size in config['batch_size']:
                ...
                for e in range(config['epoch']):
                    ...
                    if e% 150 == 0:
                        ...
                        'epinion91' if i in [0] else "epinion82",
